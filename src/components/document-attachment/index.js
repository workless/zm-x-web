...
const DocumentAttachment = ({
	item: {
		attachment,
		attachment: { contentType, filename, size },
	...
	<div
		class={cx(
			style.documentAttachment,
			style[getContentTypeExtension(contentType)] || style.default
		)}
		onClick={callWith(onTogglePreviewer, { attachment, allAttachments })}
	>
		<AttachmentBadge contentType={contentType} class={style.left} />
