...
export default function EnhancedLinkCardSmall({ url, title, domainStyles, uid, image }, isFooterCard = false, restoreToSize = CARD_SIZE.SMALL) {
	let cardDisplayType = isFooterCard ? 'display: inline-block;' : 'display: block;';
