...
export default function EnhancedLinkCardMediumAndLarge({ url, title, domainStyles, description, image, uid, cardSize }) {
	let maxWidth = 400;
	...
	let hasHeroImage = image && image.medium;
	let hasLogo = domainStyles && domainStyles.logo;
