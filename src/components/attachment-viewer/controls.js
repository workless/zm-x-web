...
export default class AttachmentViewerControls extends Component {
	render({ onPreviousAttachment, onNextAttachment, onZoomIn, onZoomOut, previousLabel, nextLabel, zoomOutLabel, zoomInLabel }) {
		return (
			<div class={style.controls}>
				...
				<Button aria-label={zoomOutLabel} onClick={onZoomOut}>
					<Icon size="sm" name="fa:search-minus" />
				</Button>
				<Button aria-label={zoomInLabel} onClick={onZoomIn}>
					<Icon size="sm" name="fa:search-plus" />
				</Button>
