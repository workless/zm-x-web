		...
		<div>
			...
			<AlignedForm>
				...
				<FormGroup>
					...
					<Select
						value={value.ownerCalendarId}
						onChange={onFieldChange('ownerCalendarId', value, onChange)}
				...
				<FormGroup>
					...
					<ColorPicker
						onChange={onFieldChange('color', value, onChange)}
						value={value.color}
					/>
				</FormGroup>
